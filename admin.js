...
async function cekSesi() {
  ...
  if (session) {
    ...
    document.getElementById('btnToggleAdmin').style.display = 'inline-flex';
  }
}
...
function initAuthListeners() {
  ...
  document.getElementById('btnBatalLogin').addEventListener('click', (e) => {
    e.preventDefault();
    document.getElementById('viewLogin').style.display = 'none';
    document.getElementById('btnToggleAdmin').style.display = 'inline-flex';
  });
